...
{
	if (flag)
		m_iCurrentFileStyle |= (int)FileType::Document;
	else
		m_iCurrentFileStyle ^= (int)FileType::Document;
...
{
	if (flag)
		m_iCurrentFileStyle |= (int)FileType::Image;
	else
		m_iCurrentFileStyle ^= (int)FileType::Image;
...
{
	if (flag)
		m_iCurrentFileStyle |= (int)FileType::Video;
	else
		m_iCurrentFileStyle ^= (int)FileType::Video;
...
{
	if (flag)
		m_iCurrentFileStyle |= (int)FileType::Music;
	else
		m_iCurrentFileStyle ^= (int)FileType::Music;
